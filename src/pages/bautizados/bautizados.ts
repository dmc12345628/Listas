...
@Component({
  selector: 'page-bautizados',
  templateUrl: 'bautizados.html'
})
export class BautizadosPage {
  celulaForm: FormGroup;

  bautizados$: Observable<any[]>;
  ...
  constructor(public navCtrl: NavController,
    ...
    this.bautizados$ = combineLatest(
      this.celulaFilter$
    ).pipe(
      switchMap(([celula]) =>
        afs.collection('Bautizados', ref => {
